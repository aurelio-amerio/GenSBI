...
from gensbi.recipes import Flux1JointSMPipeline
...
# The Flux1JointSMPipeline handles the training loop and sampling using score matching.
...
plt.savefig("flux1joint_sm_pipeline_marginals.png", dpi=100, bbox_inches="tight")
plt.show()
...
plt.savefig("flux1joint_sm_pipeline_pf_marginals.png", dpi=100, bbox_inches="tight")
plt.show()
