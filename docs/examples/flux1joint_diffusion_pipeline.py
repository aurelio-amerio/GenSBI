...
from gensbi.recipes import Flux1JointDiffusionPipeline
...
# The Flux1JointDiffusionPipeline handles the training loop and sampling.
...
training_config = Flux1JointDiffusionPipeline.get_default_training_config()
training_config["nsteps"] = 10000

pipeline = Flux1JointDiffusionPipeline(
    train_dataset_grain,
    val_dataset_grain,
    dim_obs,
    dim_cond,
...
plt.savefig("flux1joint_diffusion_pipeline_marginals.png", dpi=100, bbox_inches="tight")
plt.show()
