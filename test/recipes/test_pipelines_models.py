...
def test_defaults_flux1(pipeline_cls):
    ...
    assert isinstance(
        default_params, Flux1Params
    ), f"Expected Flux1Params, got {type(default_params)}"
...
def test_defaults_flux1joint(pipeline_cls):
    ...
    assert isinstance(
        default_params, Flux1JointParams
    ), f"Expected Flux1JointParams, got {type(default_params)}"
...
def test_defaults_simformer(pipeline_cls):
    ...
    assert isinstance(
        default_params, SimformerParams
    ), f"Expected SimformerParams, got {type(default_params)}"
