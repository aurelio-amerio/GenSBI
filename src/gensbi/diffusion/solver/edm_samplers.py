...
def edm_sampler(
    ...
    *,
    ...
    def one_step(carry, i):
        ...
        # Euler step.
        denoised = sde.denoise(model, x_hat, t_hat[...,None], **model_kwargs) # TODO test
...
def edm_ablation_sampler(
    ...
    def one_step(carry, i):
        ...
        # Euler step.
        h = t_next - t_hat
        denoised = sde.denoise(model, x_hat/sde.s(t_hat), sde.sigma(t_hat)[...,None], **model_kwargs)
        ...
        if method == "Heun":
            # Apply 2nd order correction.        
            def apply_2nd_order_correction():  # Function for i < (n_steps - 1)
                denoised = sde.denoise(model, x_prime/sde.s(t_prime), sde.sigma(t_prime)[...,None], **model_kwargs)
