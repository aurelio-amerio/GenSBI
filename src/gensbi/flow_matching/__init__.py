...
# This file is a derivative work based on the Facebook Research Flow Matching library.
# Substantial modifications and extensions by Aurelio Amerio, 2025.
# If you use this package, please consider citing the original Flow Matching papers and library.

"""
Flow Matching Models in GenSBI
-----------------------------

This module is largely modeled after https://github.com/facebookresearch/flow_matching,
